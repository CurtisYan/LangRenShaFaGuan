const commonDay = (exposure = 'double') => ({ sheriff: true, sheriffVoteWeight: 1.5, exposure })
const common = (id, name, summary, roleCounts, nightActions, specialRules = [], exposure = 'double') => ({ id, name, summary, playerCount: 12, roleCounts, nightActions, dayRules: commonDay(exposure), rules: ['暗牌，有警长', `${exposure === 'double' ? '双曝' : '单曝'}吞警徽`, '女巫全程不能自救', ...specialRules] })
